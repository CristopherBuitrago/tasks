                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('tasks.update', $task->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full rounded-md shadow-sm bg-gray-700 text-white border-gray-600 focus:border-blue-500 focus:ring-blue-500">{{ $task->description }}</textarea>
                        </div>
